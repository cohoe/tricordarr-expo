...
import { LfgCreateScreenBase } from '@tricordarr/components/Screens/LFG/LfgCreateScreenBase';
...
export const BoardgameCreateLfgScreen = ({ route }: Props) => {
  const description = `Play a board game! We'll be playing "${route.params.boardgame.gameName
    }".\n\nRemember, LFG is not a game reservation service. The game library has ${route.params.boardgame.numCopies
