...
import { HealthResponse, SwiftarrClientConfig } from '@tricordarr/libraries/Structs/ControllerStructs';
import { useOpenQuery, usePublicQuery } from '@tricordarr/components/Queries/OpenQuery';
