...
import { MicroKaraokeCompletedSong } from '@tricordarr/libraries/Structs/ControllerStructs';
...
import { useMicroKaraokeSongQuery } from '@tricordarr/components/Queries/MicroKaraoke/MicroKaraokeQueries';
